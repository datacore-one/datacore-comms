...
```bash
cd /home/user/Data/.datacore/modules/comms
...
python3 /home/user/Data/.datacore/lib/link_verifier.py --url https://example.com
...
To adjust verification rules, edit `/home/user/Data/.datacore/lib/link_verifier.py`:
...
- `/home/user/Data/.datacore/lib/link_verifier.py` - Core verification logic
- `/home/user/Data/.datacore/lib/late_api_wrapper.py` - Late API integration
- `/home/user/Data/.datacore/modules/comms/lib/x_poster.py` - X API integration
- `/home/user/Data/.datacore/modules/comms/lib/content_scheduler.py` - Scheduler integration
- `/home/user/Data/.datacore/modules/comms/tests/test_link_verification.py` - Tests
